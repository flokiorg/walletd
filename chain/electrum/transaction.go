...
// GetHashFromPositionResp represents the response to GetMerkleProof().
type GetHashFromPositionResp struct {
	Result *GetHashFromPositionResult `json:"result"`
}

// GetHashFromPositionResult represents the content of the result field in the response to GetHashFromPosition().
type GetHashFromPositionResult struct {
...
func (s *Client) GetHashFromPosition(ctx context.Context, height, position uint32) (*GetHashFromPositionResult, error) {
	var resp GetHashFromPositionResp
