...
// RPCClient represents a persistent client connection to a flokicoin RPC server
...
// operate on the same flokicoin network as described by the passed chain
...
type RPCClientConfig struct {
	...
	// Params defines a Flokicoin network by its parameters.
...
// Start method.  If the remote server does not operate on the same flokicoin
...
// flokicoin RPC server.  This channel must be continually read or the process
...
// parseBlock parses a ws definition of the block a tx is mined it to the
