...
func (b *daemonZMQEvents) Start() error {
...
// Stop cleans up any of the resources and goroutines held by daemonZMQEvents.
func (b *daemonZMQEvents) Stop() error {
	b.mempool.Shutdown()
...
// NOTE: This must be run as a goroutine.
func (b *daemonZMQEvents) mempoolPoller() {
	defer b.wg.Done()
