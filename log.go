...
import (
	...
	"github.com/flokiorg/walletd/rpc/legacyrpc"
	"github.com/flokiorg/walletd/rpc/rpcserver"
...
var (
	...
	flcnLog      = backendLog.Logger("FLCN")
)
...
func init() {
	...
	neutrino.UseLogger(flcnLog)
}

// subsystemLoggers maps each subsystem identifier to its associated logger.
var subsystemLoggers = map[string]flog.Logger{
	"FLCW": log,
	"WLLT": walletLog,
	"TMGR": txmgrLog,
	"CHNS": chainLog,
