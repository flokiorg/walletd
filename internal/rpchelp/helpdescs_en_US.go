...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in flokicoin",
	"getbalance--result1":    "The balance of all accounts valued in flokicoin",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in flokicoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in flokicoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in flokicoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and flokicoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in flokicoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in flokicoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in flokicoin",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in flokicoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in flokicoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in flokicoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in flokicoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in flokicoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in flokicoin",
	...
	"settxfee-amount":    "The new fee increment valued in flokicoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in flokicoin.",
