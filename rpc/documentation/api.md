...
start the flokicoind RPC client.  This RPC client is used for wallet syncing and
...
- `string network_address`: The host/IP and optional port of the RPC server to
  ...
  default port is chosen corresponding to the default flokicoind RPC port of the
