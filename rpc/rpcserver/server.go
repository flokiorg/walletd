...
//
//	https://github.com/flokiorg/walletd/blob/master/rpc/documentation/api.md
//
// Any API changes must be performed according to the steps listed here:
//
//	https://github.com/flokiorg/walletd/blob/master/rpc/documentation/serverchanges.md
package rpcserver
...
import (
	...
	pb "github.com/flokiorg/walletd/rpc/walletrpc"
...
func StartWalletService(server *grpc.Server, wallet *wallet.Wallet) {
	service := &walletServer{wallet: wallet}
