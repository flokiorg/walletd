...
var (
	...
	rootKey, _ = hdkeychain.NewCustomMaster([]byte("Bitcoin seed"), seed, &chaincfg.MainNetParams)
	...
	expectedAddrs = []expectedAddr{
		{
			address:     "F9n15TFSE2TFd5F9QVXfWX8UEoud2LzFDd",
		...
		{
			address:     "FSsKbYQ7Rj89VV4u5NDFXmz2SoWi5bLHtn",
		...
		{
			address:     "F6Ka8je9Zc5JemEtGqVRggtUqNaHL2y5ec",
		...
		{
			address:     "F8HjhXVjYo8CstKc2jmoJsiUNgYi1J2Z3o",
		...
		{
			address:     "FRHquV8q2xq7hKNm61Qo1RXpz9erSHr9rw",
		...
		{
			address:     "FA7VBjRQZBZEz2tsHK4Wz7CLLCVoA2qigP",
		...
		{
			address:     "FR8vjebTsEixY6YKhT94roMnXCdavmznaR",
		...
		{
			address:     "F8CozmTs3eac15Z3KEm4uy3KzU4vL2iKo8",
		...
		{
			address:     "FFNDRxj1f49UsnXx2QGrJkJqhchF5odtDw",
		...
		{
			address:     "FPSDdaUPh4D62eDXhnAr274x9RjC1oiBxC",
