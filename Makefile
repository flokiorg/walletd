PKG := github.com/flokiorg/walletd
...
#? build: Compile and build walletd
build:
	@$(call print, "Compiling walletd.")
	$(GOBUILD) $(PKG)/...

#? install: Install walletd, dropwtxmgr and sweepaccount, place them in $GOPATH/bin
install:
	@$(call print, "Installing walletd.")
	$(GOINSTALL) $(PKG)
...
help: Makefile
	@echo " Choose a command run in walletd:"
