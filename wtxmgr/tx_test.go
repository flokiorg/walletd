...
func TestInsertsCreditsDebitsRollbacks(t *testing.T) {
	...
	// Switch txout amount to 1 FLC.  Transaction store doesn't
...
func TestCoinbases(t *testing.T) {
	...
	// Balance should be 0 if the coinbase is immature, 50 FLC at and beyond
	// maturity.
	//
...
func assertBalance(t *testing.T, s *Store, ns walletdb.ReadWriteBucket,
	confirmed bool, blockHeight int32, exp chainutil.Amount) {
...
func TestOutputLocks(t *testing.T) {
	...
	coinbase := newCoinBase(
		chainutil.LokiPerFlokicoin, chainutil.LokiPerFlokicoin*2,
	)
	coinbaseHash := coinbase.TxHash()

	// One of the spends will be unconfirmed.
	const unconfirmedBalance = chainutil.LokiPerFlokicoin / 2
	...
	const confirmedBalance = chainutil.LokiPerFlokicoin
