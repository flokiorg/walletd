...
import (
	...
	"github.com/flokiorg/walletd/internal/cfgutil"
	"github.com/flokiorg/walletd/internal/legacy/keystore"
...
type config struct {
	...
	TestNet3        bool                    `long:"testnet" description:"Use the test Flokicoin network (version 3) (default mainnet)"`
...
//
// The above results in walletd functioning properly without any config
...
func loadConfig() (*config, []string, error) {
	...
	localhostListeners["0.0.0.0"] = struct{}{} // FLZ_CHANGE
	localhostListeners["::"] = struct{}{}      // FLZ_CHANGE
	...
	if cfg.UseSPV {
		...
		if cfg.DisableClientTLS {
			// if _, ok := localhostListeners[RPCHost]; !ok { // FLZ_CHANGE : enable for all hosts
