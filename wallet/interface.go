...
type Interface interface {
	...
	HaveAddress(a chainutil.Address) (bool, error)
	...
	CalculateBalance(requiredConfirmations int32) (chainutil.Amount, error)
	...
	ListUnspent(minconf, maxconf int32, accountName string) (
		[]*chainjson.ListUnspentResult, error)
	...
	CreateSimpleTx(coinSelectKeyScope *waddrmgr.KeyScope, account uint32,
		outputs []*wire.TxOut, minconf int32, satPerKb chainutil.Amount,
	...
	SendOutputs(outputs []*wire.TxOut,
		...
		minconf int32, satPerKb chainutil.Amount,
	...
	FundPsbt(packet *psbt.Packet, keyScope *waddrmgr.KeyScope,
		minConfs int32, account uint32, feeSatPerKB chainutil.Amount,
	...
	PrivKeyForAddress(a chainutil.Address) (*btcec.PrivateKey, error)
