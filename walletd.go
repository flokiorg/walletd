...
// startChainRPC opens a RPC client connection to a flokicoind server for blockchain
...
func startChainRPC(certs []byte) (*chain.RPCClient, error) {
	...
	rpcc, err := chain.NewRPCClient(activeNet.Params, cfg.RPCConnect,
		cfg.FlokicoindUsername, cfg.FlokicoindPassword, certs, cfg.DisableClientTLS, 0)
	if err != nil {
		return nil, err
	}
	err = rpcc.Start()
